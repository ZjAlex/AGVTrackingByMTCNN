...
def _convert_to_example_simple(image_example, image_buffer, net):
    """
    covert to tfrecord file
    :param image_example: dict, an image example
    :param image_buffer: string, JPEG encoding of RGB image
    ...
    if net == 'net3':
        landmark = [bbox['xleft'], bbox['yleft'], bbox['xright'], bbox['yright']]
...
def _convert_to_example_simple_v2(image_example, image_buffer, net):
